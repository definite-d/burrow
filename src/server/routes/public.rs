...
<style>
  :root {{ --bg: #f8f5f0; --surface: #fff; --border: #e8e2d9; --text: #2c2416; --text-muted: #a89d8e; --accent: #c2752e; --danger: #b44a3f; --font-display: 'Instrument Serif', Georgia, serif; --font-body: 'Outfit', system-ui, sans-serif; --radius: 6px; }}
